                        ...
                        function initialize() {
                          ...
                          <?php $i=1;
                                ...
                                foreach($switch as $row) { 
                                   ...
                                   $count = count($row->connection_info);
                                  ?>
                                    

                                    var markerfromswitch<?php echo $i; ?> = new google.maps.Marker({
                                        ...
                                        map: map,
                                        title: "<?php echo $row->from_device_name; ?>",
                                        icon: "<?php echo base_url().'assets/admin/icons/switch.png'?>"

                                    });

                                     var markertoswitch<?php echo $i; ?> = new google.maps.Marker({

                                        position: new google.maps.LatLng(<?php echo $row->connection_info[$count-1]->end_lattitude; ?>,<?php echo $row->connection_info[$count-1]->end_longitude; ?>),
                                        map: map,
                                        title: "<?php echo $row->to_device_name; ?>",
                                        icon: "<?php echo base_url().'assets/admin/icons/switch.png'?>"
