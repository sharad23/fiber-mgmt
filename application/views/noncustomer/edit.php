                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-10">
                                    <form role="form" method="post" action="<?php echo base_url()?>noncustomer/update" >
                                        ...
                                        <div class="form-group" id="pod_info" >
                                            ...
                                            <table><tr>
                                            <input type="hidden"  name="pod_id[]" class="form-control" value="<?php echo $data[0]->from_pod_id; ?>" />
                                            <td><input type="text"  name="device_location[]" class="form-control" value="<?php echo $data[0]->from_device_location; ?>" /></td>
                                            <td><input type="text"  name="device[]" class="form-control" value="<?php echo $data[0]->from_device_name; ?>" /></td>
                                            <td><input type="text"  name="port[]" class="form-control" value="<?php echo $data[0]->from_device_port; ?>" /></td></tr></table>
                                        ...
                                        <div class="form-group" id="pod_info" >
                                            ...
                                            <table><tr>
                                            <input type="hidden"  name="pod_id[]" class="form-control" value="<?php echo $data[0]->to_pod_id; ?>" />
                                            <td><input type="text"  name="device_location[]" class="form-control" value="<?php echo $data[0]->to_device_location; ?>" /></td>
                                            <td><input type="text"  name="device[]" class="form-control" value="<?php echo $data[0]->to_device_name; ?>" /></td>
                                            <td><input type="text"  name="port[]" class="form-control" value="<?php echo $data[0]->to_device_port; ?>" /></td></tr></table>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="core_type" name="core_type"  required>
                                                <option value="<?php echo $data[0]->core_type; ?>"><?php if($data[0]->core_type) { echo "Single core"; }else{ echo "Double core"; } ?></option>
                                                <option value="">-------------</option>
