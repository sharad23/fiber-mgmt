                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-10">
                                    <form role="form" method="post" action="<?php echo base_url()?>master/insert" >
                                       
                                        <div class="form-group">
                                            <label>Master Name</label>
                                            <input id="name" class="form-control" name="name" required placeholder="Master Name">
                                        </div>
                                       
                                        <div class="form-group">
                                            <label>Master Location</label>
                                            <input id="location" class="form-control" name="location" required placeholder="Master Location">
                                        </div>

                                          <div class="form-group">
                                            <label>Gps(long/lat)</label>
                                            <table><tr>
                                            <td><input type="text" id="start_long" name="longitude" class="form-control" required placeholder="Longitude" /></td>
                                            <td> <input type="text" id="start_lat" name="lattitude" class="form-control" required placeholder="Lattitude" /></td></tr></table>
                                          </div>
                                        ...
                                        <div class="form-group" id="pod_info" hidden>
                                            ...
                                            <table><tr>
                                            <td><input type="text"  name="device_location" class="form-control" /></td>
                                            <td><input type="text"  name="device" class="form-control" /></td>
                                            <td><input type="text"  name="port" class="form-control" /></td></tr></table>
                                        ...
                                        <div class="form-group" id="splitter_info" hidden>
                                         ...
                                         <div class="panel panel-default">
                                                <div class="panel-heading">Switch To Master</div>
                                                <div class="panel-body">
                                                      <div class="form-group">
           ...
           <script>
               $(document).ready(function(){
                        ...
                        $('#reset').click(function(){
                             ...
                             window.location = base_url+"master/add";
                        ...
                        $('#keyword').keyup(function(){
                              ...
                              $.get(base_url+'master/ajax_get_location/'+keyword,function(data){
                        ...
                        $(document).on('click','.dyn_s',function(e){
                                   ...
                                   $('#start_enc').html('');
                                   $('#keyword').val(id);
                                   $.get(base_url+'master/ajax_get_enclosure/'+id, function(data){
                        ...
                        //$('.dyn_start_enclosure').change(function(){
                              ...
                              var start = $(this).val()
                              var clickwhich = $(this)
                              $.get(base_url+'master/ajax_get_connected_enclosure/'+start,function(data){
