                          ...
                          <?php $i=1;
                                ...
                                foreach($splitter as $row) { 
                                      if($row->type == 1){
                                         ...
                                         $splitterimage = base_url().'assets/admin/icons/l1splitter.png';
                                      }
                                      elseif($row->type == 0){

                                         $splitterimage = base_url().'assets/admin/icons/splitter.png';
                                      }
                                  ?>
                                    //for splitter 
                                    var markercleint<?php echo $i; ?> = new google.maps.Marker({

                                        position: new google.maps.LatLng(<?php echo $row->latittude; ?>,<?php echo $row->longitude; ?>),
                                        map: map,
                                        title: "<?php echo $row->name; ?>",
                                        icon: "<?php echo $splitterimage; ?>"

                                    });

                                    //for olt
                                    var markerolt<?php echo $i; ?> = new google.maps.Marker({

                                        position: new google.maps.LatLng(<?php echo $row->connection_info[0]->start_lattitude; ?>,<?php echo $row->connection_info[0]->start_longitude; ?>),
                                        map: map,
                                        title: "<?php echo $row->device_name; ?>",
                                        icon: "<?php echo base_url().'assets/admin/icons/olt.png'; ?>"
